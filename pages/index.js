    ...
    <>
      <div className="bg-gray-100 min-h-screen">
        <div className="container mx-auto px-4">
          <div
            className="flex justify-center items-center py-20 md:py-60 px-10  bg-cover bg-center"
            style={{
              backgroundImage:
          ...
          >
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 tracking-wide uppercase">
                Notes Repository
              </h1>
              <h2 className="text-3xl md:text-2xl text-center text-gray-900 mt-8 sm:text-base">
                Organize your thoughts and unleash your creativity with our
                powerful notes website - your one-stop destination for all your
                note-taking needs!
              </h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-10">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <img
                ...
                alt="Branch 2"
              />
              <h2 className="text-lg font-bold mb-2">Information Science</h2>
              <p className="text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <img
                ...
                alt="Branch 4"
              />
              <h2 className="text-lg font-bold mb-2">Civil</h2>
              <p className="text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <img
                ...
                alt="Branch 6"
              />
              <h2 className="text-lg font-bold mb-2">Mechanical</h2>
              <p className="text-gray-700">
